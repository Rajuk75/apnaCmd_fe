...
import { ArrowRight, TrendingUp, Users, Clock, Trophy } from 'lucide-react';
          ...
          <div key={study.id} className="group">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8">
              <div>
                ...
                <h2 className="text-3xl md:text-6xl font-display font-black text-slate-900">{study.project}</h2>
              </div>
              <div className="hidden md:block">
                <button className="flex items-center gap-2 px-6 py-3 rounded-full border border-slate-200 text-slate-700 hover:bg-blue-500 hover:border-blue-500 hover:text-white transition-all font-medium shadow-soft">
            ...
            {/* Main Visual */}
            <div className="relative h-[400px] md:h-[600px] rounded-2xl overflow-hidden mb-12 border border-slate-200 group-hover:border-blue-300 transition-colors shadow-soft-lg">
              ...
              <div className="absolute top-8 left-8 z-20">
                <div className="w-16 h-16 rounded-full bg-blue-500 text-white flex items-center justify-center font-bold text-xl shadow-blue-glow">
                  {study.logo}
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-lg leading-relaxed border-l-2 border-blue-500 pl-6">
                     {study.solution}
                  </p>
                </div>
                <div className="md:hidden">
                   <button className="mt-4 flex items-center gap-2 text-blue-600 font-bold">
                     Read Full Story <ArrowRight className="w-4 h-4" />
                   </button>
                </div>
              </div>
              ...
              {/* Right: Stats & Outcome */}
              <div className="bg-white p-8 rounded-2xl border border-slate-200 hover:border-blue-300 transition-colors shadow-soft">
                ...
                <div className="space-y-6">
                  {study.stats.map((stat, i) => (
                    <div key={i} className="flex items-center justify-between border-b border-slate-100 pb-4 last:border-0 last:pb-0">
                      ...
                      <span className="text-xl font-bold text-blue-600 font-mono">{stat.value}</span>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* Divider */}
            {index !== cases.length - 1 && <div className="h-px bg-slate-200 mt-32"></div>}
          </div>
        ))}
      </div>
    </PageLayout>
